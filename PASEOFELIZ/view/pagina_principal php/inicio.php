    ...
    <div id="contenedor_general" class="app-container">
        ...
        <main class="main-content">
            ...
            <section class="services-list">
                    ...
                    <div class="service-details">
                        <div class="card-header-row">
                            ...
                            <div class="ratings-and-actions">
                                <a href="paseos_info.php" class="btn-ver-mas">Ver más</a>
                ...
                <article class="service-card">
                    ...
                    <div class="service-details">
                        <div class="card-header-row">
                            ...
                            <div class="ratings-and-actions">
                                <div class="ratings-and-actions">
                                    <a href="adiestramiento_info.php" class="btn-ver-mas">Ver más</a>
                                    <i class="far fa-heart heart-icon"></i>
                                </div>
                            </div>
                        </div>
                ...
                <article class="service-card">
                    <div class="service-icon-container">
                        <img src="../assets/recursos_pagina_principal/iconhospedaje.png" alt="Adiestramiento">
                    </div>
                    <div class="service-details">
                        <div class="card-header-row">
                            ...
                            <div class="ratings-and-actions">
                                <div class="ratings-and-actions">
                                    <a href="hospedaje_info.php" class="btn-ver-mas">Ver más</a>
                                    <i class="far fa-heart heart-icon"></i>
                                </div>
                            </div>
                        </div>
