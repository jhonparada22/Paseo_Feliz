...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // ── Eliminar una mascota (form independiente) ──────────────────────
    ...
    if ($mascota_accion === 'agregar') {
        ...
        $nombre_mascota_edit = isset($_POST['nombre_mascota_edit']) ? trim($_POST['nombre_mascota_edit']) : '';
        $raza_mascota_edit = isset($_POST['raza_mascota_edit']) ? trim($_POST['raza_mascota_edit']) : '';
        $edad_mascota_edit = isset($_POST['edad_mascota_edit']) ? trim($_POST['edad_mascota_edit']) : '';
        ...
        if ($id_mascota > 0) {
            ...
            if ($datos_mascota) {
                ...
                $nombre_final = $nombre_mascota_edit !== '' ? $nombre_mascota_edit : $datos_mascota['nombre_mascota'];
                $raza_final   = $raza_mascota_edit !== '' ? $raza_mascota_edit : $datos_mascota['raza'];
                $edad_final   = $edad_mascota_edit !== '' ? intval($edad_mascota_edit) : $datos_mascota['edad'];
