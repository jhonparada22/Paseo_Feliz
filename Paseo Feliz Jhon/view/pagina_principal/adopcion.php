...
<head>
    ...
    <link rel="stylesheet" href="../css/principal_css/adopcion.css?v=<?php echo @filemtime(__DIR__ . '/../css/principal_css/adopcion.css'); ?>">
...
<div class="toast-proceso" id="toastProceso">
    <i class="fas fa-check-circle"></i> ¡Solicitud enviada! Te avisaremos cuando el equipo la revise.
</div>
...
<script>
    ...
    if (new URLSearchParams(window.location.search).get('solicitud') === 'enviada') {
        const t = document.getElementById('toastProceso');
        t.classList.add('show');
        setTimeout(() => t.classList.remove('show'), 3500);
        window.history.replaceState({}, '', 'adopcion.php'); // limpia el ?solicitud= de la URL
    }
</script>
</body>
</html>