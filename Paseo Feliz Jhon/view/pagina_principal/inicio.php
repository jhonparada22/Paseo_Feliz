...
<head>
    ...
    <link rel="stylesheet" href="../css/principal_css/inicio_cliente.css?v=<?php echo @filemtime(__DIR__ . '/../css/principal_css/inicio_cliente.css'); ?>">
    ...
    <link rel="stylesheet" href="../css/principal_css/wizard_paseos.css?v=<?php echo @filemtime(__DIR__ . '/../css/principal_css/wizard_paseos.css'); ?>">
    <!-- Dashboard post-compra del servicio de Paseos -->
    <link rel="stylesheet" href="../css/principal_css/dashboard_paseos.css?v=<?php echo @filemtime(__DIR__ . '/../css/principal_css/dashboard_paseos.css'); ?>">
    ...
    <!-- PWA: instalable para el cliente -->
    <link rel="manifest" href="../apk/manifest_cliente.json">
...
<div id="contenedor_general" class="app-container">
    ...
    <main class="main">
        ...
        <!-- Banner "Comprar [servicio] para otra mascota" — SIEMPRE visible,
             tanto si se ve la vitrina normal como si el dashboard post-compra
             (dashboard_paseos.js) reemplaza la vitrina. Lo llena
             inicio_cliente.js según el servicio activo (tab) y qué mascotas
             ya tienen esa membresía. -->
        <div id="otra-mascota-banner"></div>
        ...
        <!-- DASHBOARD POST-COMPRA DE HOSPEDAJE (dashboard_hospedaje.js) -->
        <section id="hospedaje-dashboard" hidden></section>

        <!-- DASHBOARD POST-COMPRA DE ADIESTRAMIENTO (dashboard_adiestramiento.js) -->
        <section id="adiestramiento-dashboard" hidden></section>
...
<script src="../js/js pagina principal/dashboard_hospedaje.js?v=<?php echo @filemtime(__DIR__ . '/../js/js pagina principal/dashboard_hospedaje.js'); ?>"></script>
<script src="../js/js pagina principal/dashboard_adiestramiento.js?v=<?php echo @filemtime(__DIR__ . '/../js/js pagina principal/dashboard_adiestramiento.js'); ?>"></script>
