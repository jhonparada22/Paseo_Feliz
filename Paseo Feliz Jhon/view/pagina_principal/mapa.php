...
<head>
  ...
  <!-- Sidebar unificado del cliente (misma barra que inicio/Chat/adopción/usuario) -->
...
<div class="splash" id="splash">
  ...
  <div class="splash-sub">Conectando con la ubicación de tu mascota...</div>
  <div class="splash-spinner"></div>
</div>

<!-- SHELL PRINCIPAL -->
<div class="app-shell" id="contenedor_general">
...
<div class="arrival-overlay" id="arrivalOverlay">
  <div class="ao-card">
    ...
    <div class="ao-title" id="aoTitle">¡Tu mascota está llegando!</div>
    <div class="ao-msg"   id="aoMsg">El paseador está cerca de tu casa. Prepárate para recibirla.</div>
