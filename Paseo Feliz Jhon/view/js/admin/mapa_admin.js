...
function initMap() {
    ...
    // Refresca posición GPS de paseadores cada 5 segundos
    setInterval(cargarPaseadores, 5000);
}

// ═══════════════════════════════════════════════════════════════
// CARGAR PASEADORES DESDE EL BACKEND
// ═══════════════════════════════════════════════════════════════
...
// ═══════════════════════════════════════════════════════════════
// LLENAR EL SELECT DE PASEADORES
// ═══════════════════════════════════════════════════════════════
...
// ═══════════════════════════════════════════════════════════════
// RENDER RUTAS HOY (usa listaRutasHoy real)
// ═══════════════════════════════════════════════════════════════
function renderRutasHoy() {
    ...
    listaRutasHoy.forEach(r => {
        ...
        const estadoLabel = { en_curso: '🔵 En ruta', pendiente: '⏰ Pendiente', pausada: '⏸ Pausada', finalizada: '✅ Finalizada', cancelada: '✖ Cancelada' }[r.estado] || r.estado;
...
// ═══════════════════════════════════════════════════════════════
// ASIGNAR RUTA → FETCH REAL AL BACKEND
// ═══════════════════════════════════════════════════════════════
