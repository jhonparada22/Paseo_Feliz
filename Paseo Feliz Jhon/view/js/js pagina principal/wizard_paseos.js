...
(function () {
    ...
    // Hora EXACTA de inicio del paseo: de 6:00 a.m. a 4:30 p.m. en pasos de
    // 30 min. Con la duración elegida queda definido el intervalo real del
    // servicio (ej. 7:00 – 8:00), que es lo que el admin usa para asignar
    ...
    function alertaPaso(msg) {
        ...
        if (!al) {
            ...
            $('#wizard-paseos .wz-modal').appendChild(al);
        }
        al.textContent = '⚠ ' + msg;
