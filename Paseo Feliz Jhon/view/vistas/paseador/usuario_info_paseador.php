...
<body class="paseador-page">
    <div id="contenedor_general" class="app-container">
        ...
        <nav class="sidebar">
            ...
            <ul class="nav-links">
                ...
                <li class="active"><a href="usuario_paseador.php"><i class="fas fa-user"></i><span>Mi Perfil</span></a></li>
            </ul>
        </nav>

        <main class="edit-main-content">
            <div class="edit-header-title">
                <a href="usuario_paseador.php"><i class="fas fa-arrow-left"></i></a>
                <h2>Modificar Datos de Perfil</h2>
            </div>

            <form action="../../../controller/guardar_perfil_paseador.php" method="POST" enctype="multipart/form-data">
    ...
    <form id="form-eliminar-mascota" action="../../../controller/guardar_perfil_paseador.php" method="POST" style="display:none;">
    ...
    <script>
        ...
        /* Menú hamburguesa: manejado por usuario_info.js (línea 301) — no duplicar aquí */
    </script>
</body>
</html>