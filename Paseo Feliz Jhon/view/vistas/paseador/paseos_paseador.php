...
<head>
    ...
    <link rel="stylesheet" href="../../css/paseador/paseos_paseador.css?v=<?php echo @filemtime(__DIR__ . '/../../css/paseador/paseos_paseador.css'); ?>">
...
<body class="paseador-page">
    ...
    <script src="../../js/paseador/paseos_paseador.js?v=<?php echo @filemtime(__DIR__ . '/../../js/paseador/paseos_paseador.js'); ?>"></script>
