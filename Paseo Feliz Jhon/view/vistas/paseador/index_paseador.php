...
<head>
    ...
    <link rel="stylesheet" href="../../css/paseador/paseador_dashboard.css?v=<?php echo @filemtime(__DIR__ . '/../../css/paseador/paseador_dashboard.css'); ?>">
    ...
    <link rel="manifest" href="../../apk/manifest_paseador.json">
...
<body class="paseador-page">
    ...
    <script src="../../js/paseador/paseador.js?v=<?php echo @filemtime(__DIR__ . '/../../js/paseador/paseador.js'); ?>"></script>
