...
<head>
  ...
  <link rel="stylesheet" href="../../css/admin/admin.css?v=<?php echo @filemtime(__DIR__ . '/../../css/admin/admin.css'); ?>">
    <link rel="stylesheet" href="../../css/admin/usuarios_admin.css?v=<?php echo @filemtime(__DIR__ . '/../../css/admin/usuarios_admin.css'); ?>">
  ...
  <div class="main-content">
    <main class="page-area">
      ...
      <div class="mini-stats">
        ...
        <div class="mini-stat">
          <div class="ms-icon purple"><i class="fas fa-shield-halved"></i></div>
...
<script src="../../js/admin/usuarios_admin.js?v=<?php echo @filemtime(__DIR__ . '/../../js/admin/usuarios_admin.js'); ?>"></script>
</body>
</html>