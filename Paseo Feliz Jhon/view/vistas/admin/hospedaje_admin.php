...
<head>
  ...
  <title>Paseo Feliz – Gestión de Hospedaje</title>
  ...
  <!-- ══ SIDEBAR ══════════════════════════════════════════════ -->
        <nav class="sidebar">
            ...
            <ul class="nav-links">
                ...
                <li class="active"><a href="#"><i class="fas fa-house"></i><span>Hospedaje</span></a></li>
    ...
    <main class="page-area">
      <div class="page-header">
        <div>
          ...
          <div class="sub">Reservas de hospedaje: marca los hitos de recogida y entrega de la van a medida que ocurren.</div>
        </div>
      ...
      <div class="mini-stats">
        <div class="mini-stat"><div class="ms-icon ms-blue"><i class="fas fa-receipt"></i></div><div><div class="ms-val" id="st-total">0</div><div class="ms-lbl">Reservas totales</div></div></div>
        <div class="mini-stat"><div class="ms-icon ms-orange"><i class="fas fa-clock"></i></div><div><div class="ms-val" id="st-pendientes">0</div><div class="ms-lbl">Por recoger</div></div></div>
        <div class="mini-stat"><div class="ms-icon ms-purple"><i class="fas fa-house"></i></div><div><div class="ms-val" id="st-hospedadas">0</div><div class="ms-lbl">En hospedaje</div></div></div>
        <div class="mini-stat"><div class="ms-icon ms-green"><i class="fas fa-flag-checkered"></i></div><div><div class="ms-val" id="st-entregadas">0</div><div class="ms-lbl">Entregadas</div></div></div>
        <div class="mini-stat"><div class="ms-icon ms-red"><i class="fas fa-ban"></i></div><div><div class="ms-val" id="st-cancel">0</div><div class="ms-lbl">Canceladas</div></div></div>
      </div>

      <div class="filter-bar">
        <div class="si-wrap"><i class="fas fa-search"></i><input type="text" id="searchInput" placeholder="Buscar por mascota, cliente o barrio..."/></div>
        <button class="sf-btn active" data-filter="todos">Todas</button>
        <button class="sf-btn" data-filter="pendientes">Por recoger</button>
        <button class="sf-btn" data-filter="hospedadas">En hospedaje</button>
        <button class="sf-btn" data-filter="entregadas">Entregadas</button>
      </div>

      <div class="content-grid">
        <div>
          <div class="cards-grid" id="cardsGrid"></div>
          <div class="empty-state" id="emptyState"><i class="fas fa-house"></i><p>No se encontraron reservas con ese criterio.</p></div>
        </div>
        <div class="detail-panel" id="detailPanel">
          <div class="dp-empty" id="dpEmpty"><i class="fas fa-paw"></i><p>Selecciona una reserva<br>para ver el detalle y actualizar su estado</p></div>
...
<script src="../../js/admin/hospedaje_admin.js?v=<?php echo @filemtime(__DIR__ . '/../../js/admin/hospedaje_admin.js'); ?>"></script>
</body>
</html>
