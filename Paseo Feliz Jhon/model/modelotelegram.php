...
class ModeloTelegram
{
    ...
    // ── Chat ADOPCIÓN (solicitudes de cita) ────────────────────────
    private string $chatIdAdopcion;

    // ── Chat SOPORTE (reportes de problemas de usuarios/paseadores) ─
    private string $chatIdSoporte;
    ...
    public function __construct()
    {
        ...
        $this->chatIdAdopcion = "-5532121891";   // solicitudes de adopción
        $this->chatIdSoporte  = "-5314435814";   // reportes de soporte
    }
    ...
    // ── Público: notificar solicitud de adopción ──────────────────
    public function enviarMensajeAdopcion(string $mensaje): array
    {
        return $this->enviar($this->chatIdAdopcion, $mensaje);
    }

    // ── Público: reportes de soporte de usuarios/paseadores ────────
    public function enviarMensajeSoporte(string $mensaje): array
    {
        return $this->enviar($this->chatIdSoporte, $mensaje);
    }
}
