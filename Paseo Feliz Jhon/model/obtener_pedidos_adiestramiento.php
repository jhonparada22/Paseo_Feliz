<?php
/**
 * obtener_pedidos_adiestramiento.php
 * Lista para el ADMIN los pedidos de adiestramiento (pedidos_adiestramiento)
 * con su asignación de entrenador (cronograma_adiestramiento), igual que
 * obtener_pedidos_paseos.php pero para este servicio.
...
$sqlBase =
    "SELECT p.id_pedido, p.id_usuario, p.id_mascota, p.cantidad_sesiones,
            p.duracion_min, p.dias_preferidos, p.franja_horaria,
...
// ── Asignaciones de cronograma por pedido ──────────────────────────
...
while ($row = $res->fetch_assoc()) {
    $pedidos[] = [
        ...
        'cantidad_sesiones' => (int)$row['cantidad_sesiones'],
